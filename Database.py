...
def DatabaseCreate():
    cnx = mysql.connector.connect(user='root', password='0506', host='localhost')
    Cursor = cnx.cursor()
...
def TablesCreate():
    cnx = mysql.connector.connect(user='root', password='0506', host='localhost', database='Inventory')
    Cursor = cnx.cursor()
